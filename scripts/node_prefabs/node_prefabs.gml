function node_button(_name, _navigable = true, _origin = NODE_ORIGIN.MIDDLE_CENTER) : node(_name, _origin) constructor
{
	...
	sound_select = snd_ui_select;
	sound_click = snd_ui_confirm;
	...
	processor.add_process(function(_node) {
		_node.text = language_get_localized_text(_node.text_key);
		_node.font = language_get_localized_font(_node.font_key);
	}, true);
	...
	static node_text_set_colors = function(_c1, _c2 = _c1, _c3 = _c1, _c4 = _c1)
	{
		color1 = _c1;
		color2 = _c2;
		color3 = _c3;
