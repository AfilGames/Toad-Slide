...
var _spit = (input_check_released("game_interact") and !(obj_main.is_winning() or obj_main.is_dying() or (grab_clock > 0)) and array_contains(interact_type, "dedicated_input") and (!grid_data.check_moving_pushable() or move_while_pushable_moving));
if _spit {
	interact();
}
